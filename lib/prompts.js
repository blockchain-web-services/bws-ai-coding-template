 ...
 */
export async function askProjectInfo(projectRoot, existingConfig = null) {
    ...
    const useAWSDefault = existingConfig?.useAWS !== undefined ? existingConfig.useAWS : false;
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            type: 'confirm',
            name: 'useAWS',
            message: existingConfig ? `Does your project use AWS deployments? (current: ${existingConfig.useAWS ? 'Yes' : 'No'})` : 'Does your project use AWS deployments?',
            default: useAWSDefault
        }
    ]);
